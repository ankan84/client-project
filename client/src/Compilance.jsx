...
<div className='content' >
    <Cards_left href="acc" image={accounting_img}
    ...
    ></Cards_left>
    <Cards_right href="dig" image={digital}
    ...
    ></Cards_right>
    <Cards_left href="imp" image={imp_img}
    ...
    ></Cards_left>
    <Cards_right href="com" image={company}
    ...
    ></Cards_right>
    <Cards_left href="com_tan" image={tan}
    ...
    ></Cards_left>
    <Cards_right href="bar" image={bar}
    title="Bar Code"
    ...
    ></Cards_left>
    <Cards_right href="shop" image={shop}
    title="Shop Act"
    ...
    ></Cards_right>
      <Cards_left href="fss" image={fsai}
    title="FSSAI"
    ...
    ></Cards_left>
    <Cards_right href="itr" image={itr}
    title="ITR Filing"
